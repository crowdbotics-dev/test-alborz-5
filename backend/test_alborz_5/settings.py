"""
Django settings for test_alborz_5 project.
...
ROOT_URLCONF = 'test_alborz_5.urls'
...
WSGI_APPLICATION = 'test_alborz_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "test-Alborz Support <support@test-alborz-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_alborz_5 API",
    "DESCRIPTION": "API documentation for test_alborz_5 App",
    "VERSION": "v1",
}
